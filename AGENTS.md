...
This project is indexed by GitNexus as **xtmux** (947 symbols, 1944 relationships, 69 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
