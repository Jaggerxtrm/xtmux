...
This project is indexed by GitNexus as **xtmux** (2256 symbols, 5118 relationships, 188 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
