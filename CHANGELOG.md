...
- Correct Codex K1 replay evidence (xtmux-s96.1) ([3417f34](https://github.com/Jaggerxtrm/xtmux/commit/3417f34d88dfb1f62d496aa8a1726166151a486a))
...
- Make --for optional under tmux for hook queries (#87) ([cd5ec84](https://github.com/Jaggerxtrm/xtmux/commit/cd5ec84e67da8e6726689a67e31d56bd355eddaa))

### Coordination and hooks
- Align message and Claude Stop semantics (#76) ([ff2cb57](https://github.com/Jaggerxtrm/xtmux/commit/ff2cb571b8c06c893b3ad09f633baec77c3d0422))
...
- Skip merge commits so CI == local (xtrm-reyem.13) (#71) ([048b742](https://github.com/Jaggerxtrm/xtmux/commit/048b742d01db5d0c05e5d4e413ecdedeba47a8e5))
- Widen session event stream and beads cursor ([ed8497c](https://github.com/Jaggerxtrm/xtmux/commit/ed8497cd0d607c962de42171dfdc781f1846211a))
- Bound Claude turn transcript capture (#75) ([101fa07](https://github.com/Jaggerxtrm/xtmux/commit/101fa079a49fdc28f37f19fd9fb5f299315ff861))
- Mint a Claude agent instance id on SessionStart (#79) ([03575e5](https://github.com/Jaggerxtrm/xtmux/commit/03575e540e30efdbbb01715b1a861aba7299419f))
- Stop wait-agent replaying a stale done on a working pane (#81) ([afef8b6](https://github.com/Jaggerxtrm/xtmux/commit/afef8b6abb67708b01db4944d36f43f225b51508))
- Tag Codex agent-state hooks and mint their instance id (#82) ([9708c2d](https://github.com/Jaggerxtrm/xtmux/commit/9708c2d823916f95a981c494a97a20d175c38d14))
- Bound safe-send-pointer's obs subprocess by wall-clock (#84) ([3d7088c](https://github.com/Jaggerxtrm/xtmux/commit/3d7088c84783a7a72e4cd7981b2bf5492d24abda))
- Overlay terminal_status onto the projected state (#85) ([9f6a423](https://github.com/Jaggerxtrm/xtmux/commit/9f6a4232df16209f23fcc74b2665483f6886597d))
- Self-reap when the parent shell dies (#86) ([b5c0683](https://github.com/Jaggerxtrm/xtmux/commit/b5c06834e2b3c12079e8812de51cd53596ee31b9))
- Let direct --from-npm proceed for drift repair (xtrm-9hq6w) (#88) ([6b8f521](https://github.com/Jaggerxtrm/xtmux/commit/6b8f521123234e5686758cd3a628c2dff10e6d2e))
...
- Add pr-review-gate required-status-check workflow ([082e96f](https://github.com/Jaggerxtrm/xtmux/commit/082e96f4406e653e795a53ea665f2913533558d5))
- Wave-2 — pull_request_review_comment trigger + preserve CR verdicts ([1c1caaf](https://github.com/Jaggerxtrm/xtmux/commit/1c1caafddbd399fabaf563849f4c36c4bf177ae5))
- Pi-column contract matrix for the cross-runtime gate (#77) ([283a94c](https://github.com/Jaggerxtrm/xtmux/commit/283a94c58def37cffa68d8bdfd45653269094683))
- Untrack specialists/beads runtime state (xtrm-136tf) (#80) ([b57c5e7](https://github.com/Jaggerxtrm/xtmux/commit/b57c5e7d8346da39bf15513d8c122111eb66320c))
- Commit the injected communication-style + task-tracking block (xtrm-wiy5n.4.36) (#83) ([2eccd79](https://github.com/Jaggerxtrm/xtmux/commit/2eccd79b69e51516ff7dd59275e110e5918a8760))
<!-- generated by xtmux-changelog; edit commit messages or cliff.toml, not generated rows -->
